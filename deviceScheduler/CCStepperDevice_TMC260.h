...
public:
    ...
    /*!
     * \brief creates a new represenatation of a stepper motor connected to a TMC260 stepper driver
     *
     * This is the main constructor.
     *
     * \param step_pin the pin, where the step pin of the TMC260 driver is connected.
     * \param dir_pin the pin, where the direction input of the TMC26X is connected.
     * \param enable_pin the pin, where the enable input of the TMC26X is connected.
     * \param chipSelect_pin the pin, where the Client Select Pin (CS) of the TMC260 for SPI is connected.
     ...
     * \param randomOffTime Use random off time for noise reduction (0 for off, -1 for on).
