...
#define STEPPER_STOCK_MICROSTEP_0_PIN       2
#define STEPPER_STOCK_MICROSTEP_1_PIN       3
#define STEPPER_STOCK_MICROSTEP_2_PIN       4

#define STEPPER_STOCK_HIGHEST_STEPPINGMODE  5        
#define STEPPER_STOCK_STEPMODECODE          {0x00, 0x01, 0x02, 0x03, 0x07}
#define STEPPER_STOCK_ANGLE_PER_STEP        1.8
